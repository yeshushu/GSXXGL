...
<head>
    ...
    $(function(){
		$("#jsgl").click(function(){
			$("#J_iframe").attr("src","${ctx}/userController/findAll");
		});

		$("#yxgl").click(function(){
			$("#J_iframe").attr("src","${ctx}/DepInfoController/findAll");
		});

		$("#gggl").click(function(){
			$("#J_iframe").attr("src","${ctx}/notieController/findAll");
		});
     });
    </script>
</head>
...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:12px;">
                                        <i class="fa fa-user"></i>
                                        <strong class="font-bold">Admin:${User.userName}</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                ...
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    <span class="ng-scope">院校信息中心</span>
                </li>
                 <li id="gggl">
                    <a class="J_menuItem" href="annmanager_manage.html">
                ...
                <li class="line dk"></li>
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    <span class="ng-scope">教务管理中心</span>
                </li>
                <li>
                    <a class="J_menuItem" href="project_manage.html">
                        <i class="fa fa-folder-open"></i>
                        <span class="nav-label">科研项目</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="rewards_manage.html">
                        <i class="fa fa-trophy"></i>
                        <span class="nav-label">奖惩信息</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="course_manage.html">
                        <i class="fa fa-book"></i>
                        <span class="nav-label">课程管理</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="user_info.html">
                        <i class="fa fa-user"></i>
                ...
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                 ...
                 <li>
                    <a class="J_menuItem" href="../test.html">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="welcome.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
...
<!-- 自定义js -->
<script src="../../common/js/hAdmin.js?v=4.1.0"></script>
